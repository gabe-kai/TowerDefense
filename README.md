...
Pre-production design repository for a tower defense + settlement builder game about a bound spirit managing a wizard's tower and village through recurring monster waves.

## Project Status

This repository is currently design-first and pre-production focused.
...
There is no gameplay code yet. The main purpose of this repository right now is to organize, refine, and preserve the game's design.
...
- `docs/`
  ...
  - subsystem specs
  - faction designs
  - documentation policy and decision log
...
The repository uses a current-truth documentation model:
