...
### `/processes`
Development processes, workflows, and procedures.

**Current Processes:**
- `CI_CD.md` - Continuous Integration and Deployment workflow

### `/implementation-guides`
Technical guides for implementing features, using systems, and development practices.
